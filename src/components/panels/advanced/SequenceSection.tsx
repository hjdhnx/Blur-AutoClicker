  ...
  return (
    <div className="adv-sectioncontainer adv-sequence-card">
      <div className="adv-card-header">
        ...
        >
          {showInfo ? <InfoIcon text={t("advanced:sequence.tooltip")} /> : null}
          <span className="adv-card-title">
            {t("advanced:sequence.heading")}
          </span>
        </div>
        <ToggleBtn
      ...
      <Disableable enabled={settings.sequenceEnabled}>
        <div className="adv-sequence-body">
          <div className="adv-sequence-controls">
            ...
            >
              {pickingSequence
                ? t("advanced:sequence.cancelPicking")
                : t("advanced:sequence.startPicking")}
            </button>
                        ...
                        >
                          ...
                          <div className="adv-sequence-leading">
                            ...
                            <button
                              ...
                              aria-label={t("advanced:sequence.dragHandle")}
                              onPointerDown={(event) => {
                                event.preventDefault();
                          ...
                          <div className="adv-sequence-actions">
                            <button
                              ...
                              aria-label={t("advanced:sequence.delete")}
                              title={t("advanced:sequence.delete")}
                            >
                              <svg
                                width="16"
                                height="16"
